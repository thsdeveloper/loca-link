      ...
      <div className="container-custom relative z-10">
        ...
        <div className="relative px-8 lg:px-16">
          ...
          <button
            ...
            className={`absolute left-0 top-1/2 -translate-y-1/2 z-20 w-12 h-12 lg:w-14 lg:h-14 rounded-full flex items-center justify-center transition-all duration-300 ${
              canGoPrev
          ...
          <button
            ...
            className={`absolute right-0 top-1/2 -translate-y-1/2 z-20 w-12 h-12 lg:w-14 lg:h-14 rounded-full flex items-center justify-center transition-all duration-300 ${
              canGoNext
                ? "bg-accent/20 border-2 border-accent/50 text-accent hover:bg-accent/30 hover:border-accent hover:scale-110 cursor-pointer shadow-lg shadow-accent/20"
                : "bg-primary-800/50 border border-primary-600/30 text-foreground-muted/30 cursor-not-allowed"
            }`}
                ...
                >
                  ...
                  {plan.badge && (
                    <div className="absolute -top-0 left-1/2 -translate-x-1/2 z-20">
                      <div className={`px-4 py-1.5 rounded-b-xl text-xs font-bold uppercase tracking-wider ${
                        plan.featured
                  ...
                  <div className="relative z-10 p-6 pt-8 flex flex-col h-full min-h-[540px]">
                    ...
                    <div className="text-center mb-4">
                      <div className={`w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center transition-all duration-300 group-hover:scale-110 ${
                        plan.featured 
                    ...
                    <a
                      ...
                      className={`w-full inline-flex items-center justify-center gap-2 py-3.5 px-6 rounded-xl font-semibold transition-all duration-300 group/btn ${
                        plan.featured
