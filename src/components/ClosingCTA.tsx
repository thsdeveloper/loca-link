    ...
    <section id="contato" className="section-padding relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <span className="inline-block px-4 py-2 rounded-full bg-accent/10 border border-accent/30 text-sm text-accent mb-6">
          ...
          <p className="text-xl text-foreground-muted max-w-2xl mx-auto mb-4">
            Seu evento em Brasília merece conexão de qualidade. Retirada imediata e orçamento personalizado.
          </p>

          {/* Slogan */}
          <p className="text-accent font-medium text-lg mb-10">
            {BRAND.slogan}
          </p>
          ...
          <p className="mt-8 text-sm text-foreground-muted">
            Brasília e Entorno • Retirada Imediata • Orçamento Gratuito
          </p>
        </div>
      </div>
    </section>
