...
import { HERO_CONTENT, BRAND, WHATSAPP_LINK } from "@/lib/constants";
      ...
      <div className="container-custom relative z-10 py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Slogan */}
            <p className="text-accent font-medium text-lg mb-8 animate-fade-in-up delay-200">
              {BRAND.slogan}
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 mt-12 pt-8 border-t border-primary-600/30 animate-fade-in-up delay-400">
              <div>
                <p className="text-2xl sm:text-3xl font-bold text-accent">1 dia+</p>
                <p className="text-sm text-foreground-muted">Aluguel mínimo</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm text-foreground-muted">Brasil coberto</p>
              </div>
            </div>
          </div>
